...
clinical_datapath='/data/home/tqi/data1/share/after_freesurfer/FILE/Normative_model/Datasets/Dataset-diseases/Clinical_vars.csv'  # Change the directory where you save the clinical variables  
MR_datapath='/data/home/tqi/data1/share/after_freesurfer/FILE/Normative_model/Datasets/Dataset-diseases/MR_measures.xlsx'  # Change the directory where you save the MR measures  
savepath1='/data/home/tqi/data1/share/after_freesurfer/FILE/Normative_model/Results/newsite' #Chnage the path you have saved your normative models in "Normative-model-fit.R"; here we used our models for example
savepath='/data/home/tqi/data1/share/after_freesurfer/FILE/Normative_model/Results/Disease';# Create and determine the directory where you would save the results  
setwd(datapath)
