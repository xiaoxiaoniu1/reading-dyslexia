...
# 2. 读取 ANOVA 结果并转换为矩阵
# ==========================================
anova_file = '/data/home/tqi/data1/share/after_freesurfer/FILE/MIND_ANOVA_with_site/ANOVA_DK318_edge_results.csv'
...
mind_dir = '/data/home/tqi/data1/share/after_freesurfer/fs_subjects_all/MIND_out/'
...
# 输出目录
output_dir = '/data/home/tqi/data1/share/after_freesurfer/FILE/MIND_ANOVA_with_site/'
...
def compute_edge_effect_direction(demo_df, mind_dir, n_nodes, group_col, group_a, group_b):
    ...
    demo_df['file_base'] = demo_df['subj_prefix'] 
