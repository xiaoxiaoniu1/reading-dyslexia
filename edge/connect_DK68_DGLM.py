...
# 2. 读取 DGLM 结果并转换为矩阵
# ==========================================
dglm_file = '/data/home/tqi/data1/share/after_freesurfer/FILE/test_mean_1.5/MIND_DK68_DGLM/DGLM_DK68_edge_results.csv'
...
mind_dir = '/data/home/tqi/data1/share/after_freesurfer/FILE/test_mean_1.5/MIND_DK68_combat/'
...
# 输出目录
output_dir = '/data/home/tqi/data1/share/after_freesurfer/FILE/test_mean_1.5/MIND_DK68_DGLM/'
...
for target_p_col in target_p_cols:
    ...
    edge_table_path = f"{output_dir}DGLM_DK68_{target_p_col}_top{top_n_edges}_edges.csv"
    ...
    output_path = f"{output_dir}DGLM_DK68_{target_p_col}_plot.png"
    plt.savefig(output_path, dpi=300, bbox_inches='tight')
    plt.close()
    print(f"✓ 图片已保存: {output_path}")

print(f"\n{'='*50}")
print("所有 DK68 DGLM edge 图片生成完成！")
print(f"{'='*50}")
