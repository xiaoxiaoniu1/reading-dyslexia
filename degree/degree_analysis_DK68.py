    ...
    for VALUE_COL in cols:
        ...
        if VALUE_COL.lower().startswith("p"):
            ...
            if "Diagnosis" in VALUE_COL:
                diag_sig_csv = os.path.join(sig_file_dir, "Significant_Diagnosis_DK68_degree_results.csv")
                ...
                age_sig_csv = os.path.join(sig_file_dir, "Significant_AgeGroup_DK68_degree_results.csv")
