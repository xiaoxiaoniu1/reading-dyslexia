...
if __name__ == "__main__":
    ...
    dk68_csv = os.path.join(BASE_DIR, "FILE/MIND_DK68_ANOVA_with_site", "ANOVA_DK68_degree_results_with_site.csv")
    dk68_out = os.path.join(BASE_DIR, "FILE/MIND_DK68_ANOVA_with_site", "dk68_degree_brainmaps(ANOVA_site)")
