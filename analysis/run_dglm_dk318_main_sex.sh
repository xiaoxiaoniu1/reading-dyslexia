#!/bin/bash
#SBATCH --job-name=DK318_DGLM_main_sex
#SBATCH --output=analysis/logs/DK318_DGLM_main_sex_%j.out
#SBATCH --error=analysis/logs/DK318_DGLM_main_sex_%j.err
...
Rscript dglm_dk318_degree_edge_main_sex.R "${ANALYSIS_TYPE}"
...
if [[ "${ANALYSIS_TYPE}" == "both" || "${ANALYSIS_TYPE}" == "degree" ]]; then
  ...
  bash /data/home/tqi/data1/share/after_freesurfer/CODE/analysis/run_violin_dk318.sh main_sex
  echo "===== STEP 3/3 DONE ====="
  echo "Output dir (STEP 3/3): ${VIOLIN_DIR}"
fi
