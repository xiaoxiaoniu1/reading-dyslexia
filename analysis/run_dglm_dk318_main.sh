#!/bin/bash
#SBATCH --job-name=DK318_DGLM_main
#SBATCH --output=analysis/logs/DK318_DGLM_main_%j.out
#SBATCH --error=analysis/logs/DK318_DGLM_main_%j.err
...
Rscript dglm_dk318_degree_edge_main.R "${ANALYSIS_TYPE}"
