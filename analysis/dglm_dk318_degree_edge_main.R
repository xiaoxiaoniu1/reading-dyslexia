...
# Usage:
#   Rscript dglm_dk318_degree_edge_main.R [both|degree|edge]
...
Sys.setenv(DK318_DGLM_OUT_ROOT = "/data/home/tqi/data1/share/after_freesurfer/FILE/test_mean_1.5/MIND_DK318_DGLM_main")
