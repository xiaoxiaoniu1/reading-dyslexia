#!/bin/bash
#SBATCH --job-name=DK68_DGLM_strat
#SBATCH --output=logs/DK68_DGLM_stratified_%j.out
#SBATCH --error=logs/DK68_DGLM_stratified_%j.err
...
RESULT_DIR="/data/home/tqi/data1/share/after_freesurfer/FILE/test_mean_1.5/MIND_DK68_DGLM_stratified"
BRAINMAP_DIR="${RESULT_DIR}/stratified_brainmaps"
VIOLIN_DIR="${RESULT_DIR}/VIOLIN_Followup_stratified"
R_SCRIPT="/data/home/tqi/data1/share/after_freesurfer/CODE/analysis/dglm_stratified_dk68.R"
...
if [[ "${ANALYSIS_TYPE}" == "both" || "${ANALYSIS_TYPE}" == "degree" ]]; then
  ...
  python /data/home/tqi/data1/share/after_freesurfer/CODE/degree/plot_significant_DK68_stratified_brainmaps.py \
  ...
  bash /data/home/tqi/data1/share/after_freesurfer/CODE/analysis/run_violin_dk68_stratified.sh \
    "${RESULT_DIR}" \
    "DK68 stratified"
  echo "===== STEP 3/3 DONE ====="
  echo "Output dir (STEP 3/3): ${VIOLIN_DIR}"
