# Wrapper for DK318 DGLM with IQ covariate.
# It sources dglm_dk318_degree_edge.R from the same directory when possible.
# Usage:
#   Rscript dglm_dk318_degree_edge_main_iq.R [both|degree|edge]
...
Sys.setenv(DK318_DGLM_OUT_ROOT = "/data/home/tqi/data1/share/after_freesurfer/FILE/test_mean_1.5/MIND_DK318_DGLM_main_iq")
Sys.setenv(DK318_DGLM_INCLUDE_AGE = "false")
Sys.setenv(DK318_DGLM_INCLUDE_IQ = "true")
Sys.setenv(DK318_DGLM_SEX_FILTER = "")
