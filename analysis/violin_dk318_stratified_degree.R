...
mk <- function(csv,pcol,kind,subset_var,subset_level,x_var,facet_var,effect){
  data.frame(
    csv=csv,
    pcol=pcol,
    kind=kind,
...
tasks <- bind_rows(
  mk("DGLM_DK318_Child_degree_results.csv","p_mean_Diagnosis_Sex_Interaction","mean","AgeGroup_Fac","Child","Diagnosis_Fac","Sex","mean_diagnosis_by_sex"),
  mk("DGLM_DK318_Child_degree_results.csv","p_mean_Diagnosis_Sex_Interaction_FDR","mean","AgeGroup_Fac","Child","Diagnosis_Fac","Sex","mean_diagnosis_by_sex"),
  mk("DGLM_DK318_Child_degree_results.csv","p_disp_Diagnosis_Sex_Interaction","disp","AgeGroup_Fac","Child","Diagnosis_Fac","Sex","disp_diagnosis_by_sex"),
  mk("DGLM_DK318_Child_degree_results.csv","p_disp_Diagnosis_Sex_Interaction_FDR","disp","AgeGroup_Fac","Child","Diagnosis_Fac","Sex","disp_diagnosis_by_sex"),
  mk("DGLM_DK318_Adult_degree_results.csv","p_mean_Diagnosis_Sex_Interaction","mean","AgeGroup_Fac","Adult","Diagnosis_Fac","Sex","mean_diagnosis_by_sex"),
  mk("DGLM_DK318_Adult_degree_results.csv","p_mean_Diagnosis_Sex_Interaction_FDR","mean","AgeGroup_Fac","Adult","Diagnosis_Fac","Sex","mean_diagnosis_by_sex"),
  mk("DGLM_DK318_Adult_degree_results.csv","p_disp_Diagnosis_Sex_Interaction","disp","AgeGroup_Fac","Adult","Diagnosis_Fac","Sex","disp_diagnosis_by_sex"),
  mk("DGLM_DK318_Adult_degree_results.csv","p_disp_Diagnosis_Sex_Interaction_FDR","disp","AgeGroup_Fac","Adult","Diagnosis_Fac","Sex","disp_diagnosis_by_sex"),
  mk("DGLM_DK318_DD_Adult_vs_Child_degree_results.csv","p_mean_AgeGroup_Sex_Interaction","mean","Diagnosis_Fac","DD","AgeGroup_Fac","Sex","mean_agegroup_by_sex"),
  mk("DGLM_DK318_DD_Adult_vs_Child_degree_results.csv","p_mean_AgeGroup_Sex_Interaction_FDR","mean","Diagnosis_Fac","DD","AgeGroup_Fac","Sex","mean_agegroup_by_sex"),
  mk("DGLM_DK318_DD_Adult_vs_Child_degree_results.csv","p_disp_AgeGroup_Sex_Interaction","disp","Diagnosis_Fac","DD","AgeGroup_Fac","Sex","disp_agegroup_by_sex"),
  mk("DGLM_DK318_DD_Adult_vs_Child_degree_results.csv","p_disp_AgeGroup_Sex_Interaction_FDR","disp","Diagnosis_Fac","DD","AgeGroup_Fac","Sex","disp_agegroup_by_sex"),
  mk("DGLM_DK318_TD_Adult_vs_Child_degree_results.csv","p_mean_AgeGroup_Sex_Interaction","mean","Diagnosis_Fac","TD","AgeGroup_Fac","Sex","mean_agegroup_by_sex"),
  mk("DGLM_DK318_TD_Adult_vs_Child_degree_results.csv","p_mean_AgeGroup_Sex_Interaction_FDR","mean","Diagnosis_Fac","TD","AgeGroup_Fac","Sex","mean_agegroup_by_sex"),
  mk("DGLM_DK318_TD_Adult_vs_Child_degree_results.csv","p_disp_AgeGroup_Sex_Interaction","disp","Diagnosis_Fac","TD","AgeGroup_Fac","Sex","disp_agegroup_by_sex"),
  mk("DGLM_DK318_TD_Adult_vs_Child_degree_results.csv","p_disp_AgeGroup_Sex_Interaction_FDR","disp","Diagnosis_Fac","TD","AgeGroup_Fac","Sex","disp_agegroup_by_sex"),
  mk("DGLM_DK318_Female_Diagnosis_AgeGroup_degree_results.csv","p_mean_Diagnosis_AgeGroup_Interaction","mean","Sex","Female","Diagnosis_Fac","AgeGroup_Fac","mean_diagnosis_by_agegroup"),
  mk("DGLM_DK318_Female_Diagnosis_AgeGroup_degree_results.csv","p_mean_Diagnosis_AgeGroup_Interaction_FDR","mean","Sex","Female","Diagnosis_Fac","AgeGroup_Fac","mean_diagnosis_by_agegroup"),
  mk("DGLM_DK318_Female_Diagnosis_AgeGroup_degree_results.csv","p_disp_Diagnosis_AgeGroup_Interaction","disp","Sex","Female","Diagnosis_Fac","AgeGroup_Fac","disp_diagnosis_by_agegroup"),
  mk("DGLM_DK318_Female_Diagnosis_AgeGroup_degree_results.csv","p_disp_Diagnosis_AgeGroup_Interaction_FDR","disp","Sex","Female","Diagnosis_Fac","AgeGroup_Fac","disp_diagnosis_by_agegroup"),
  mk("DGLM_DK318_Male_Diagnosis_AgeGroup_degree_results.csv","p_mean_Diagnosis_AgeGroup_Interaction","mean","Sex","Male","Diagnosis_Fac","AgeGroup_Fac","mean_diagnosis_by_agegroup"),
  mk("DGLM_DK318_Male_Diagnosis_AgeGroup_degree_results.csv","p_mean_Diagnosis_AgeGroup_Interaction_FDR","mean","Sex","Male","Diagnosis_Fac","AgeGroup_Fac","mean_diagnosis_by_agegroup"),
  mk("DGLM_DK318_Male_Diagnosis_AgeGroup_degree_results.csv","p_disp_Diagnosis_AgeGroup_Interaction","disp","Sex","Male","Diagnosis_Fac","AgeGroup_Fac","disp_diagnosis_by_agegroup"),
  mk("DGLM_DK318_Male_Diagnosis_AgeGroup_degree_results.csv","p_disp_Diagnosis_AgeGroup_Interaction_FDR","disp","Sex","Male","Diagnosis_Fac","AgeGroup_Fac","disp_diagnosis_by_agegroup")
)
