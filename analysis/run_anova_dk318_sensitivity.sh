#!/bin/bash
#SBATCH --job-name=DK318_ANOVA_sens
#SBATCH --output=analysis/logs/DK318_ANOVA_sensitivity_%j.out
#SBATCH --error=analysis/logs/DK318_ANOVA_sensitivity_%j.err
...
# 跑R脚本
Rscript anova_dk318_degree_edge_sensitivity.R
