# Sex-stratified wrapper for DK68 DGLM.
# It runs Male and Female separately.
# Usage:
#   Rscript dglm_dk68_degree_edge_main_sex.R [both|degree|edge]
...
for (sex_label in c("Male", "Female")) {
  ...
  Sys.setenv(DK68_DGLM_OUT_ROOT = "/data/home/tqi/data1/share/after_freesurfer/FILE/test_mean_1.5/MIND_DK68_DGLM_main_sex")
  Sys.setenv(DK68_DGLM_INCLUDE_AGE = "false")
  Sys.setenv(DK68_DGLM_SEX_FILTER = sex_label)
