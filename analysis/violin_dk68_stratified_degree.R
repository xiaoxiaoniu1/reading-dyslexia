...
result_dir <- get_arg("--result-dir","/data/home/tqi/data1/share/after_freesurfer/FILE/test_mean_1.5/MIND_DK68_DGLM_stratified")
demo_file  <- get_arg("--demo-file","/data/home/tqi/data1/share/after_freesurfer/FILE/test_mean_1.5/all_data_cqt_mean_1.5.xlsx")
mind_dir   <- get_arg("--mind-combat-dir","/data/home/tqi/data1/share/after_freesurfer/FILE/test_mean_1.5/MIND_DK68_combat")
...
df <- read_excel(demo_file,sheet="Sheet1") |>
  ...
  filter(!is.na(id),subj_id!="",!is.na(Age_Raw),site!=3,has_file)
...
tasks <- bind_rows(
  mk("DGLM_DK68_Child_degree_results.csv","p_mean_Diagnosis_Sex_Interaction","mean","AgeGroup_Fac","Child","Diagnosis_Fac","mean_diagnosis_by_sex"),
  mk("DGLM_DK68_Child_degree_results.csv","p_mean_Diagnosis_Sex_Interaction_FDR","mean","AgeGroup_Fac","Child","Diagnosis_Fac","mean_diagnosis_by_sex"),
  mk("DGLM_DK68_Child_degree_results.csv","p_disp_Diagnosis_Sex_Interaction","disp","AgeGroup_Fac","Child","Diagnosis_Fac","disp_diagnosis_by_sex"),
  mk("DGLM_DK68_Child_degree_results.csv","p_disp_Diagnosis_Sex_Interaction_FDR","disp","AgeGroup_Fac","Child","Diagnosis_Fac","disp_diagnosis_by_sex"),
  mk("DGLM_DK68_Adult_degree_results.csv","p_mean_Diagnosis_Sex_Interaction","mean","AgeGroup_Fac","Adult","Diagnosis_Fac","mean_diagnosis_by_sex"),
  mk("DGLM_DK68_Adult_degree_results.csv","p_mean_Diagnosis_Sex_Interaction_FDR","mean","AgeGroup_Fac","Adult","Diagnosis_Fac","mean_diagnosis_by_sex"),
  mk("DGLM_DK68_Adult_degree_results.csv","p_disp_Diagnosis_Sex_Interaction","disp","AgeGroup_Fac","Adult","Diagnosis_Fac","disp_diagnosis_by_sex"),
  mk("DGLM_DK68_Adult_degree_results.csv","p_disp_Diagnosis_Sex_Interaction_FDR","disp","AgeGroup_Fac","Adult","Diagnosis_Fac","disp_diagnosis_by_sex"),
  mk("DGLM_DK68_DD_Adult_vs_Child_degree_results.csv","p_mean_AgeGroup_Sex_Interaction","mean","Diagnosis_Fac","DD","AgeGroup_Fac","mean_agegroup_by_sex"),
  mk("DGLM_DK68_DD_Adult_vs_Child_degree_results.csv","p_mean_AgeGroup_Sex_Interaction_FDR","mean","Diagnosis_Fac","DD","AgeGroup_Fac","mean_agegroup_by_sex"),
  mk("DGLM_DK68_DD_Adult_vs_Child_degree_results.csv","p_disp_AgeGroup_Sex_Interaction","disp","Diagnosis_Fac","DD","AgeGroup_Fac","disp_agegroup_by_sex"),
  mk("DGLM_DK68_DD_Adult_vs_Child_degree_results.csv","p_disp_AgeGroup_Sex_Interaction_FDR","disp","Diagnosis_Fac","DD","AgeGroup_Fac","disp_agegroup_by_sex"),
  mk("DGLM_DK68_TD_Adult_vs_Child_degree_results.csv","p_mean_AgeGroup_Sex_Interaction","mean","Diagnosis_Fac","TD","AgeGroup_Fac","mean_agegroup_by_sex"),
  mk("DGLM_DK68_TD_Adult_vs_Child_degree_results.csv","p_mean_AgeGroup_Sex_Interaction_FDR","mean","Diagnosis_Fac","TD","AgeGroup_Fac","mean_agegroup_by_sex"),
  mk("DGLM_DK68_TD_Adult_vs_Child_degree_results.csv","p_disp_AgeGroup_Sex_Interaction","disp","Diagnosis_Fac","TD","AgeGroup_Fac","disp_agegroup_by_sex"),
  mk("DGLM_DK68_TD_Adult_vs_Child_degree_results.csv","p_disp_AgeGroup_Sex_Interaction_FDR","disp","Diagnosis_Fac","TD","AgeGroup_Fac","disp_agegroup_by_sex")
)
