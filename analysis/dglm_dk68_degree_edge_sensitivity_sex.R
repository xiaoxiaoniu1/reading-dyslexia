...
# Usage:
#   Rscript dglm_dk68_degree_edge_sensitivity_sex.R [both|degree|edge]
...
for (sex_label in c("Male", "Female")) {
  ...
  Sys.setenv(DK68_DGLM_OUT_ROOT = "/data/home/tqi/data1/share/after_freesurfer/FILE/test_mean_1.5/MIND_DK68_DGLM_sensitivity_sex")
