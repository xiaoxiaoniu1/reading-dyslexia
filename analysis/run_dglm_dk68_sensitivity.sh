#!/bin/bash
#SBATCH --job-name=DK68_DGLM_sens
#SBATCH --output=analysis/logs/DK68_DGLM_sensitivity_%j.out
#SBATCH --error=analysis/logs/DK68_DGLM_sensitivity_%j.err
...
Rscript dglm_dk68_degree_edge_sensitivity.R "${ANALYSIS_TYPE}"
echo "===== STEP 1/3 DONE ====="
if [[ "${ANALYSIS_TYPE}" == "both" || "${ANALYSIS_TYPE}" == "degree" ]]; then
  ...
  bash /data/home/tqi/data1/share/after_freesurfer/CODE/analysis/run_violin_dk68.sh sensitivity
  echo "===== STEP 3/3 DONE ====="
fi
echo "End: $(date)"
