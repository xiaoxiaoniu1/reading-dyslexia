#!/bin/bash
#SBATCH --job-name=DK68_DGLM_main_sex
#SBATCH --output=analysis/logs/DK68_DGLM_main_sex_%j.out
#SBATCH --error=analysis/logs/DK68_DGLM_main_sex_%j.err
...
Rscript dglm_dk68_degree_edge_main_sex.R "${ANALYSIS_TYPE}"
echo "===== STEP 1/3 DONE ====="
if [[ "${ANALYSIS_TYPE}" == "both" || "${ANALYSIS_TYPE}" == "degree" ]]; then
  ...
  bash /data/home/tqi/data1/share/after_freesurfer/CODE/analysis/run_violin_dk68.sh main_sex
  echo "===== STEP 3/3 DONE ====="
fi
echo "End: $(date)"
