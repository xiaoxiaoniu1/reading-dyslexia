#!/bin/bash
#SBATCH --job-name=DK68_ANOVA_sens
#SBATCH --output=analysis/logs/DK68_ANOVA_sensitivity_%j.out
#SBATCH --error=analysis/logs/DK68_ANOVA_sensitivity_%j.err
...
# 跑R脚本
Rscript anova_dk68_degree_edge_sensitivity.R
